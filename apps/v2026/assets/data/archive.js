export default [
    {
        ...
        images: {
            thumb: require('@/assets/img/archive/cusme_thumb.png'),
            mainvisual: require('@/assets/img/archive/cusme_main.png'),
            mainvisual_mb: require('@/assets/img/archive/cusme_main_mb.png'),
            pc1: require('@/assets/img/archive/cusme_pc1.png'),
            pc2: require('@/assets/img/archive/cusme_pc2.png'),
            pc3: require('@/assets/img/archive/cusme_pc3.png'),
            mb1: require('@/assets/img/archive/cusme_mb1.png'),
            mb2: require('@/assets/img/archive/cusme_mb2.png'),
            mb3: require('@/assets/img/archive/cusme_mb3.png'),
            pc4: require('@/assets/img/archive/cusme_pc4.png'),
            pc5: require('@/assets/img/archive/cusme_pc5.png'),
            pc6: require('@/assets/img/archive/cusme_pc6.png'),
        },
        content: {
            about: {
    ...
    },
    {
        ...
        images: {
            thumb: require('@/assets/img/archive/damgon_thumb.png'),
            mainvisual: require('@/assets/img/archive/damgon_main.png'),
            pc1: require('@/assets/img/archive/damgon_pc1.png'),
            pc2: require('@/assets/img/archive/damgon_pc2.png'),
            pc3: require('@/assets/img/archive/damgon_pc3.png'),
            mb1: require('@/assets/img/archive/damgon_mb1.png'),
            mb2: require('@/assets/img/archive/damgon_mb2.png'),
            mb3: require('@/assets/img/archive/damgon_mb3.png'),
            pc4: require('@/assets/img/archive/damgon_pc4.png'),
            pc5: require('@/assets/img/archive/damgon_pc5.png'),
            pc6: require('@/assets/img/archive/damgon_pc6.png'),
        },
        content: {
            about: {
    ...
    },
    {
        ...
        images: {
            thumb: require('@/assets/img/archive/myportfolio_thumb.png'),
            mainvisual: require('@/assets/img/archive/myportfolio_main.png'),
            mainvisual_mb: require('@/assets/img/archive/myportfolio_main_mb.png'),
            pc1: require('@/assets/img/archive/myportfolio_pc1.png'),
            pc2: require('@/assets/img/archive/myportfolio_pc2.png'),
            pc3: require('@/assets/img/archive/myportfolio_pc3.png'),
            mb1: require('@/assets/img/archive/myportfolio_mb1.png'),
            mb2: require('@/assets/img/archive/myportfolio_mb2.png'),
            mb3: require('@/assets/img/archive/myportfolio_mb3.png'),
        },
        content: {
            about: {
    ...
    },
    {
        ...
        images: {
            thumb: require('@/assets/img/archive/monimo_thumb.png'),
            mainvisual: require('@/assets/img/archive/monimo_main.png'),
            mainvisual_mb: require('@/assets/img/archive/monimo_main_mb.png'),
            mb1: require('@/assets/img/archive/monimo_mb1.png'),
            mb2: require('@/assets/img/archive/monimo_mb2.png'),
            mb3: require('@/assets/img/archive/monimo_mb3.png'),
        },
        content: {
            about: {
    ...
    },
    {
        ...
        images: {
            thumb: require('@/assets/img/archive/416_thumb.png'),
            mainvisual: require('@/assets/img/archive/416_main.png'),
            pc1: require('@/assets/img/archive/416_pc1.png'),
            pc2: require('@/assets/img/archive/416_pc2.png'),
            pc3: require('@/assets/img/archive/416_pc3.png'),
            mb1: require('@/assets/img/archive/416_mb1.png'),
            mb2: require('@/assets/img/archive/416_mb2.png'),
            mb3: require('@/assets/img/archive/416_mb3.png'),
        },
        content: {
            about: {
    ...
    },
    {
        ...
        images: {
            thumb: require('@/assets/img/archive/dcamp_thumb.png'),
            mainvisual: require('@/assets/img/archive/dcamp_main.png'),
            pc1: require('@/assets/img/archive/dcamp_pc1.png'),
            pc2: require('@/assets/img/archive/dcamp_pc2.png'),
            pc3: require('@/assets/img/archive/dcamp_pc3.png'),
            mb1: require('@/assets/img/archive/dcamp_mb1.png'),
            mb2: require('@/assets/img/archive/dcamp_mb2.png'),
            mb3: require('@/assets/img/archive/dcamp_mb3.png'),
        },
        content: {
            about: {
    ...
    },
    {
        ...
        images: {
            thumb: require('@/assets/img/archive/dcdc_thumb.png'),
            mainvisual: require('@/assets/img/archive/dcdc_main.png'),
            pc1: require('@/assets/img/archive/dcdc_pc1.png'),
            pc2: require('@/assets/img/archive/dcdc_pc2.png'),
            pc3: require('@/assets/img/archive/dcdc_pc3.png'),
            mb1: require('@/assets/img/archive/dcdc_mb1.png'),
            mb2: require('@/assets/img/archive/dcdc_mb2.png'),
            mb3: require('@/assets/img/archive/dcdc_mb3.png'),
        },
        content: {
            about: {
    ...
    },
    {
        ...
        images: {
            thumb: require('@/assets/img/archive/kace_thumb.png'),
            mainvisual: require('@/assets/img/archive/kace_main.png'),
            // gif: require('@/assets/img/archive/kace_gif.gif'),
            pc1: require('@/assets/img/archive/kace_pc1.png'),
            pc2: require('@/assets/img/archive/kace_pc2.png'),
            pc3: require('@/assets/img/archive/kace_pc3.png'),
            mb1: require('@/assets/img/archive/kace_mb1.png'),
            mb2: require('@/assets/img/archive/kace_mb2.png'),
            mb3: require('@/assets/img/archive/kace_mb3.png'),
        },
        content: {
            about: {
    ...
    },
    {
        ...
        images: {
            thumb: require('@/assets/img/archive/rnjob_thumb.png'),
            mainvisual: require('@/assets/img/archive/rnjob_main.png'),
            mainvisual_mb: require('@/assets/img/archive/rnjob_main_mb.png'),
            pc1: '',
            mb1: require('@/assets/img/archive/rnjob_mb1.png'),
            mb2: require('@/assets/img/archive/rnjob_mb2.png'),
            mb3: require('@/assets/img/archive/rnjob_mb3.png'),
        },
        content: {
            about: {
    ...
    },
    {
        ...
        images: {
            thumb: require('@/assets/img/archive/oxfam_thumb.png'),
            mainvisual: require('@/assets/img/archive/oxfam_main.png'),
            mainvisual_mb: require('@/assets/img/archive/oxfam_main_mb.png'),
            pc1: require('@/assets/img/archive/oxfam_pc1.png'),
            pc2: require('@/assets/img/archive/oxfam_pc2.png'),
            pc3: require('@/assets/img/archive/oxfam_pc3.png'),
            mb1: require('@/assets/img/archive/oxfam_mb1.png'),
            mb2: require('@/assets/img/archive/oxfam_mb2.png'),
            mb3: require('@/assets/img/archive/oxfam_mb3.png'),
        },
        content: {
            about: {
    ...
    },
    {
        ...
        images: {
            thumb: require('@/assets/img/archive/cabinnet_thumb.png'),
            mainvisual: require('@/assets/img/archive/cabinnet_main.png'),
            pc1: '',
            mb1: '',
        },
        content: {
